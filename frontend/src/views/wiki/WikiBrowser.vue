  ...
  <div class="wiki-layout">
    ...
    <main class="wiki-main">
      <div class="wiki-header">
        <h3>📖 Wiki</h3>
        <p class="wiki-subtitle">Wiki-Seiten durchsuchen und erkunden</p>
      </div>
      <div class="wiki-empty">
        <p>
          Wiki-Seiten erscheinen hier, sobald Dokumente importiert und die
          Wiki-Generierung aktiviert wurde.
        </p>
      </div>
    </main>
  </div>
